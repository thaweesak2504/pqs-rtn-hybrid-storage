...
### 🟠 Phase 5: Large File Refactoring (IN PROGRESS)

> [!IMPORTANT]
> **สถานะปัจจุบัน:** อยู่ระหว่างการทำ Manual Test หลัง Refactor ครั้งใหญ่ (Modularization)

**เป้าหมาย:** ลดความซับซ้อนและขนาดของไฟล์หลัก (ไม่มีไฟล์เกิน 1,500 lines ในจุดวิกฤต)
...
| --- | --------------------------------------------- | --------------------------------------------------------------------------------- | ------------ |
| 5.1 | `QuestionFormCard.tsx` (3,200 → 1,500 lines)  | แยกเป็น: AnswerKey, Reference, SubQ, Metadata Editors                             | ✅ Done      |
| 5.2 | `main.rs` (150 commands)                      | แยกเป็น `commands/*.rs`                                                           | ✅ Done      |
| 5.3 | `tests.rs` (82 KB)                            | แยกเป็น `tests/*.rs`                                                              | ✅ Done      |
| 5.4 | `schema.rs` (47 KB)                           | ย้ายไป migrations/                                                                | ✅ Done      |
| 5.5 | `CareerBranchManagerModal.tsx`                | แยก sub-components                                                                | ⏳ pending   |
| 5.6 | `PqsReferenceSection.tsx`                     | แยก hook + presentation                                                           | ⏳ pending   |
| 5.7 | `AddReferenceModal.tsx`                       | แยก form + list                                                                   | ⏳ pending   |

**Deliverables:**
- [ ] ไฟล์วิกฤต (QFC, main.rs, tests.rs) ถูกจัดการเรียบร้อย
- [ ] Tests ทั้งหมดยังผ่าน (no regression)
- [ ] Manual Test ครบทุก Section (100, 200, 300) ยืนยันแล้ว
