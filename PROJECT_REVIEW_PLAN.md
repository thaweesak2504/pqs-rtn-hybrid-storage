...
| **Phase 5** — Large File Refactoring               | ⏳ **NEXT UP** | —                                    | `main.rs`, `QuestionFormCard.tsx`, `tests.rs`                                                                                              |
...
1. **Phase 5 — Large File Refactoring** (จัดการไฟล์ยักษ์ `QuestionFormCard.tsx`, `main.rs`, `tests.rs`) เพื่อให้โค้ด maintain ได้ง่ายขึ้นก่อนไปทำ Performance
2. เคลียร์ React Hooks Warnings (37 warnings) ของ ESLint ในช่วงเวลาว่าง
...
| 5. Large File Refactoring             | 2-3 weeks | 🟡 Medium   | ⏳ **NEXT UP** | Phase 2A (schema)    |
...
**คืบหน้า:** 6 phases เสร็จแล้ว (1, 2, 2C, 3, 4, 6, 7-Part1) + 1 phase deferred (2B). **Remaining estimate:** ประมาณ 6-10 weeks sequential / **4-7 weeks** ถ้าทำ parallel บางส่วน
...
⏳ Week 6-8:   Phase 5 (Large files)     🟠 ต่อไปทันที (QuestionFormCard.tsx, main.rs)
...
### Current (ปัจจุบัน หลัง Phase 7 Part 1)
