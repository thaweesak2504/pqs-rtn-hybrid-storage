...
### ✅ Phase 5: Large File Refactoring (DONE — 2026-05-02)

**เป้าหมาย:** ลดความซับซ้อนและขนาดของไฟล์หลัก (ไม่มีไฟล์เกิน 1,500 lines ในจุดวิกฤต)

| #   | Target File                                   | Plan                                                                              | สถานะ |
| --- | --------------------------------------------- | --------------------------------------------------------------------------------- | ----- |
| 5.1 | `QuestionFormCard.tsx` (3,200 → 1,500 lines)  | แยกเป็น: AnswerKey, Reference, SubQ, Metadata Editors                             | ✅     |
| 5.2 | `main.rs` (150 commands)                      | แยกเป็น `commands/*.rs`                                                           | ✅     |
| 5.3 | `tests.rs` (82 KB)                            | แยกเป็น `tests/*.rs`                                                              | ✅     |
| 5.4 | `schema.rs` (47 KB)                           | ย้ายไป migrations/                                                                | ✅     |
| 5.5 | `CareerBranchManagerModal.tsx`                | แยก sub-components (ถ้ายังใหญ่)                                                   | ⏳     |
| 5.6 | `PqsReferenceSection.tsx`                     | แยก hook + presentation                                                           | ⏳     |
| 5.7 | `AddReferenceModal.tsx`                       | แยก form + list                                                                   | ⏳     |

**Deliverables:**
- [x] ไฟล์วิกฤต (QFC, main.rs, tests.rs) ถูกจัดการเรียบร้อย
- [x] Tests ทั้งหมดยังผ่าน (no regression)
- [x] Manual Test ครบทุก Section (100, 200, 300) ยืนยันแล้ว
