...
1. **Phase 5.5-5.7** — แยก sub-components ของ `CareerBranchManagerModal`, `PqsReferenceSection`, `AddReferenceModal` (optional, ความเสี่ยงต่ำ)
2. **Phase 7.3-7.4** — Shared Types (Rust ↔ TS) + JSDoc
3. **Phase 8** — Performance & Optimization
4. เคลียร์ React Hooks Warnings (37 warnings) ของ ESLint ในช่วงเวลาว่าง
...
- Phase 5.5-5.7 Refactoring: ✅ Done (CareerBranchManagerModal, PqsReferenceSection, AddReferenceModal)
