...
const SlideBar: React.FC = () => {
  ...
  return (
    <>
      ...
      <div 
        className={`
          fixed top-16 left-0 h-[calc(100vh-4rem)] w-64 bg-github-bg-tertiary border-r border-github-border-primary shadow-github-large z-50
          transform transition-transform duration-300 ease-in-out rounded-tr-[20px]
          ${isOpen ? 'translate-x-0' : '-translate-x-full'}
          ${!isOpen ? 'pointer-events-none' : 'pointer-events-auto'}
          md:fixed md:top-16 md:left-0 md:h-[calc(100vh-4rem)] md:shadow-github-large md:z-50 md:rounded-tr-[20px]
