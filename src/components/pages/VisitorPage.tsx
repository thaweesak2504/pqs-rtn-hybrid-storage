...
const VisitorPage: React.FC = () => {
  const { user } = useAuth()
  const [activeTab, setActiveTab] = useState<'home' | 'introductionPqs' | 'introduction100' | 'introduction200' | 'introduction300'>('home')
