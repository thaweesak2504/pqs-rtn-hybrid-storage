    ...
    <>
      ...
      {showBackdrop && (
        ...
        />
                   ...
                   {/* Panel */}
               <div
                 className={`fixed top-10 ${position === 'left' ? 'left-0' : 'right-0'} ${height} ${width} bg-github-bg-primary shadow-github-large z-50 transform transition-all duration-300 ease-out ${className} ${
