...
// Backup/export commands moved to commands/backup.rs
// Avatar commands moved to commands/avatars.rs
...
#[tauri::command]
fn check_sub_branch_usage_global(
    branch_code: String,
    sub_code: String,
) -> Result<content_database::BranchUsageReport, String> {
...
fn main() {
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![
            ...
            check_branch_usage_global,
            check_sub_branch_usage_global,
            save_trainee_answer,
